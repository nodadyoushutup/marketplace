...
- `.cursor/skills/code-python-refactor/SKILL.md`
- `.cursor/skills/code-javascript-refactor/SKILL.md`
...
`code-deslopify` Phase A), or product→platform extraction (Substrate).
...
- Python → follow `code-python-refactor`
- JavaScript / TypeScript / JSX / React → follow `code-javascript-refactor`
