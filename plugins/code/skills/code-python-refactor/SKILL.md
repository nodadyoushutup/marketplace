...
description: >-
  ...
  direction, or as the Python structure phase of code-deslopify.
---
...
(checklist, scope, report), start at `.cursor/skills/code-refactor/SKILL.md`,
...
Use `code-investigation` when ownership, runtime wiring, or apparent dead
