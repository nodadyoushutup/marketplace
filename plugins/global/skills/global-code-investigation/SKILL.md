---
name: global-code-investigation
...
```bash
python3 .cursor/skills/global-code-investigation/scripts/repo_map.py . --limit 12
```
...
```bash
python3 .cursor/skills/global-code-investigation/scripts/symbol_evidence.py 'SymbolName' . --word
```
