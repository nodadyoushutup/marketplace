---
name: global-javascript-refactor
description: >-
  ...
  ownership cleanup, or as the JavaScript structure phase of global-deslopify.
---
...
`.cursor/skills/global-refactor/SKILL.md`, which dispatches here.
...
Use `global-code-investigation` when dynamic registration, event flow,
